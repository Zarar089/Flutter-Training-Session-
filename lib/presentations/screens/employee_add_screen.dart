...
import 'package:employee_app_v1_spaghetti/presentations/screens/blocs/employee_add/employee_add_events.dart';
import 'package:employee_app_v1_spaghetti/presentations/screens/blocs/employee_add/employee_add_state.dart';
...
class _EmployeeAddScreenState extends State<EmployeeAddScreen> {
  late final EmployeeAddBloc employeeAddBloc;
  ...
  void initState() {
    super.initState();
    employeeAddBloc = getIt<EmployeeAddBloc>();
    _loadDraftIfExists();
  ...
  Future<void> _saveEmployee() async {
    ...
    employeeAddBloc.add(
      EmployeeAddSubmitTriggered(
        employee,
        isUpdate: widget.employee != null,
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => employeeAddBloc,
      child: BlocConsumer<EmployeeAddBloc, EmployeeAddState>(
        ...
        builder: (context, state) {
          final bool isLoading = state is EmployeeAddSubmitting;
            ...
            appBar: AppBar(
              ...
              actions: [
                if (widget.employee == null)
                  IconButton(
                    icon:
                        Icon(_isDraftSaved ? Icons.save : Icons.save_outlined),
